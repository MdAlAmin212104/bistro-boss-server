...
async function run() {
  try {
    ...
    app.post("/payment", async (req, res) => {
      ...
      // Convert cartIds and menuItemIds to ObjectId
      payment.cartIds = payment.cartIds.map(
        (id) => new ObjectId(id.toString())
      );
      payment.menuItemIds = payment.menuItemIds.map(
        (id) => new ObjectId(id.toString())
      );
      ...
      const query = { _id: { $in: payment.cartIds } };
